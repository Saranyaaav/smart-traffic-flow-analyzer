...
android {
    namespace = "com.alim" // <--- FIXED: Changed from com.gub
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "com.alim" // <--- FIXED: Changed from com.gub
...
compose.desktop {
    application {
        mainClass = "com.gub.app.MainKt" // <--- CHANGE BACK TO THIS (was "com.alim...")

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "com.gub"      // <--- Keep this as "com.gub" too
